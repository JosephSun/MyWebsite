      ...
      <div className="content">
        <div className="container-about-text">
          ...
          <p>
              ...
              <br/>
              <br/>
              Feel free to contact me and/or check out my work. You can find me on <Link to="https://github.com/JosephSun" target="_blank">Github</Link>, <Link to="https://github.com/JosephSun" target="_blank">Twitter</Link>, and <Link to="https://www.linkedin.com/in/josephsun4" target="_blank">LinkedIn</Link>.
          </p>
        </div>

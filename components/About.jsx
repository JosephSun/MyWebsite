    ...
    return (
      <div className="content">
        <div className="container-about-text">
          ...
          <img src="../public/pics/FacePic.jpg" alt="Profile Picture" className="profile-pic-two" height="42" width="42"/>
        ...
        <img src="../public/pics/PPic.jpg" alt="Profile Picture" className="profile-pic"/>

      ...
      <div className="content">
        <div className="container-about-text">
          ...
          <p>
              ...
              <br/>
              <br/>
              Feel free to contact me and/or check out my work. You can find me on <Link to="https://github.com/JosephSun">Github</Link>, Twitter and <Link to="https://www.linkedin.com/in/josephsun4">LinkedIn</Link>.
          </p>
        </div>
